...
class User extends CommonApi {
  ...
  factory User.fromjson(Map<String, dynamic> json) {
    return User(
      ...
      state: json["user_state"] != null ? json["user_state"] : 0,
      password:
...
class Catagory extends CommonApi {
  ...
  factory Catagory.fromjson(Map<String, dynamic> json) {
    return Catagory(
      ...
      url: json["category_photo"] != null
          ? json["category_photo"] as String
          : '',
    );
  }
}
...
class Product extends CommonApi {
  ...
  factory Product.fromjson(Map<String, dynamic> json) {
    return Product(
        id: json["product_id"] != null ? json["product_id"] : 0,
        familyID: json["family_id"] != null ? json["family_id"] as int : 0,
        catagoryID:
            json["category_id"] != null ? json["category_id"] as int : 0,
        name:
            json["product_name"] != null ? json["product_name"] as String : '',
        ...
        note: json["product_description"] != null
            ...
            : '',
        Images: json["image_filenames"] != null
            ? List.from(json["image_filenames"].toString().split(','))
            : null
