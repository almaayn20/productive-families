...
class InputFieldData {
  static const signUp = [
    InputFieldModel(label: "اســم المستخــدم",min: 2,max: 30,icon: Icons.person_outlined),
  ...
  static const userAdmin = [
    InputFieldModel(label: "اســم المستخــدم",min: 2,max: 30,icon: Icons.info_outline),
    InputFieldModel(label:"كلمــة المرور",min: 4,max: 12,icon: Icons.password),
  ];
