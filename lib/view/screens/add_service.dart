        ...
        child: ListView(
          ...
          children: [
                        ...
                        (index) => InputField(
                              ...
                              onValid: (val) {
                                return FormValidations.checkValidations(
                                    ...
                                    outerterController.admin == "عادي"
                                        ? InputFieldData
                                            .serviceScreen2[index].min!
                                        : InputFieldData
                                            .serviceScreen[index].min!,
                                    outerterController.admin == "عادي"
                                        ? InputFieldData
                                            .serviceScreen2[index].max!
                                        : InputFieldData
                                            .serviceScreen[index].max!);
                              },
                            ))
                  ],
                )),
            ...
            CustomButton(
              ...
              text: outerterController.productID1 == 0
                  ? "إضـافــــة"
                  : "نعـديـــل",
