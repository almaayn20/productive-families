        ...
        child: ListView(
          children: [
            Form(
                ...
                child: Column(
                  children:
                      List.generate(controller.admin=="ادمن"? InputFieldData.serviceScreen.length:InputFieldData.serviceScreen2.length, (index) {
                    return InputField(
                      controller: controller.listOfController(index),
                      label:controller.admin=="ادمن"? InputFieldData.serviceScreen[index].label: InputFieldData.serviceScreen2[index].label,
                      hint: controller.admin=="ادمن"? InputFieldData.serviceScreen[index].label: InputFieldData.serviceScreen2[index].label,
                      isNumber: index>1,
                      isPassword: false,
                      onValid: (val) {
                        return FormValidations.checkValidations(
                            val!,
                            controller.admin=="ادمن"? InputFieldData.serviceScreen[index].min!: InputFieldData.serviceScreen2[index].min!,
                            controller.admin=="ادمن"? InputFieldData.serviceScreen[index].max!:InputFieldData.serviceScreen2[index].max!);
                      },
                    );
                  }),
                )),
